...
const PollModal: React.FC<PollModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-[1]">
      <div className="bg-white rounded-xl shadow-lg p-6 w-1/3">
        ...
        <div>
          ...
          {options.map((option, index) => (
            <div key={index} className="flex items-center mb-2">
              ...
              />
              <button onClick={() => removeOption(index)} className="ml-2 text-red-500 font-bold">
                X
              </button>
            </div>
          ))}
          <button onClick={addOption} className="text-blue-500 font-medium mt-2">
            + Add Option
          </button>
        </div>
        <div className="mt-4">
        ...
        <div className="flex justify-end mt-6">
          <button onClick={onClose} className="mr-4 bg-gray-300 rounded-lg px-4 py-2">
            Cancel
          </button>
